 ...
 * owns it, so a photo's metadata can say who took it — and memories can count
 * the photographer among "who was there". Empty string stands in for a
 * missing make/model so the pair stays uniquely indexable.
 */
